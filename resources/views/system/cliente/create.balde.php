...
<div class="section" style="margin-left: 10px">
    ...
    <div class="section">
        ...
        <div class="card">
            ...
            <!-- Podriamos agregar el campo de logo del cliente -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="birthdate">ID Compañia (ITC)</label><b>*</b>  <!-- Se debera de tomar 3 iniciales del nombre del Proveedor/Cliente -->
